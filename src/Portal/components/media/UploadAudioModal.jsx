        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                    <h2 style={{ fontSize: '1.5rem', color: '#22c1e6', margin: 0 }}>Upload Audio Sermon</h2>
                    ...
                    {uploadType === 'file' ? (
                        ...
                        >
                            ...
                            {file ? (
                                ...
                                <>
                                    <div style={{ color: '#eff3c1', fontWeight: '500' }}>Click to select audio file</div>
                                    <div style={{ color: '#94a3b8', fontSize: '0.8rem', marginTop: '0.2rem' }}>MP3, WAV, AAC supported</div>
                                </>
                            )}
                        </div>
                    ) : (
