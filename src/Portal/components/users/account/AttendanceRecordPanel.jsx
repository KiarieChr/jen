    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                <h3 style={{ margin: 0, color: 'white', fontSize: '1.1rem' }}>Attendance History</h3>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                    ...
                    <tbody>
                        {attendanceHistory
                            ...
                            .map(record => (
                                <tr key={record.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)', color: '#cbd5e1' }}>
                                    <td style={{ padding: '1rem 0' }}>{record.date}</td>
                                    <td style={{ padding: '1rem 0', color: '#eff3c1', fontWeight: '500' }}>{record.event}</td>
                                    ...
                                    <td style={{ padding: '1rem 0', color: '#94a3b8' }}>{record.time}</td>
                                    <td style={{ padding: '1rem 0' }}>
            ...
            <div style={{ marginTop: '2rem', display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
                <div style={{ background: 'rgba(34, 193, 230, 0.1)', padding: '1rem', borderRadius: '0.8rem', border: '1px solid rgba(34, 193, 230, 0.2)', minWidth: '150px' }}>
                    <div style={{ fontSize: '0.8rem', color: '#22c1e6' }}>Total Present</div>
                    <div style={{ fontSize: '1.5rem', fontWeight: '700', color: '#eff3c1' }}>35</div>
                </div>
                <div style={{ background: 'rgba(239, 68, 68, 0.1)', padding: '1rem', borderRadius: '0.8rem', border: '1px solid rgba(239, 68, 68, 0.2)', minWidth: '150px' }}>
                    ...
                    <div style={{ fontSize: '1.5rem', fontWeight: '700', color: '#eff3c1' }}>2</div>
                </div>
                <div style={{ background: 'rgba(74, 222, 128, 0.1)', padding: '1rem', borderRadius: '0.8rem', border: '1px solid rgba(74, 222, 128, 0.2)', minWidth: '150px' }}>
                    ...
                    <div style={{ fontSize: '1.5rem', fontWeight: '700', color: '#eff3c1' }}>94%</div>
                </div>
            </div>
        </div>
    );
