        ...
        <div style={{
            ...
            <div style={{ marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)', fontSize: '0.9rem' }}>
                    <span>Leader:</span>
                    <span style={{ color: 'var(--text-color)', fontWeight: '600' }}>Pastor Sarah</span>
                </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                <div style={{ background: 'rgba(255,255,255,0.03)', padding: '1rem', borderRadius: '0.75rem' }}>
                    ...
                    <div style={{ color: 'var(--text-color)', fontSize: '1.25rem', fontWeight: '700' }}>12</div>
                </div>
                <div style={{ background: 'rgba(255,255,255,0.03)', padding: '1rem', borderRadius: '0.75rem' }}>
                    <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem', marginBottom: '0.25rem' }}>Next Gathering</div>
                    <div style={{ color: 'var(--primary)', fontSize: '1.1rem', fontWeight: '700' }}>Thursday, Feb 1st</div>
                </div>
            </div>
